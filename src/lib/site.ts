export const site = {
  ...
  description:
    "Huy Tran is a full-stack and AI engineer in Amsterdam. Multi tenant SaaS, offline first mobile apps, and agentic retrieval that cites its sources or declines.",
} as const;
