    ...
    <div className={className}>
      <svg aria-hidden="true" width="70px" height="70px" viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg">
        ...
        <path
          ...
          fill="#3E3A39"
        />
        <path d="M476.8 527.3h67.4v92.1h-67.4z" fill="#F1BA38" />
        <path d="M476.8 527.3s-6.8 89-36.2 118.4c-29.4 29.4 153.8 9 153.8 9s-50.2-57.4-50.2-127.4" fill="#F1BA38" />
        <path d="M487.4 527.3s-5 134.2-26.5 163.6 112.5 9 112.5 9-36.7-102.6-36.7-172.7" fill="#F8F1D8" />
        <path
          d="M529.5 488.9c31.4 3.8 59.8 61 59.8 61 1.9 1.9 5.2 0.6 5.2-2.1v-65.1c0-9.6-5.3-18.4-13.7-23L535 435c-2.5-1.3-5.5 0.5-5.5 3.3v50.6zM487.9 488.9c-31.4 3.8-59.8 61-59.8 61-1.9 1.9-5.2 0.6-5.2-2.1v-65.1c0-9.6 5.3-18.4 13.7-23l45.8-24.7c2.5-1.3 5.5 0.5 5.5 3.3v50.6z"
          fill="#D75655"
        />
        <path
          ...
          fill="#F1F4F1"
        />
        <path d="M511.3 292.9c-15.7 0-29.7 18.2-39 46.8h78c-9.4-28.6-23.4-46.8-39-46.8z" fill="#CD564A" />
        <path
